...
namespace Minefield.Data.Migrations
{
    ...
    [Migration("20251012005844_AddedCofferTableForPersistence")]
    partial class AddedCofferTableForPersistence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Minefield.Entities.Coffer", b =>
                {
            ...
            modelBuilder.Entity("Minefield.Entities.CofferTicket", b =>
                {
                    b.Property<ulong>("ServerId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Minefield.Entities.MinefieldUser", b =>
                {
                    ...
                    b.Property<int>("MessagesSinceCoinFlip")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Minefield.Entities.CofferTicket", b =>
                {
                    b.HasOne("Minefield.Entities.Coffer", "Coffer")
                        .WithMany("Tickets")
                        .HasForeignKey("ServerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Minefield.Entities.MinefieldUser", "User")
                        .WithMany("CofferTickets")
